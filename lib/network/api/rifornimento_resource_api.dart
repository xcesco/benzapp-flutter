...
class RifornimentoResourceApi {
  ...
  Future<Response<int>> countRifornimentosUsingGET({
    ...
    queryParams[r'gestoreId.greaterThanOrEqual'] =
        gestoreIdPeriodGreaterThanOrEqual;
    ...
    queryParams[r'litriErogati.greaterThanOrEqual'] =
        litriErogatiPeriodGreaterThanOrEqual;
    queryParams[r'litriErogati.in'] = litriErogatiPeriodIn;
    queryParams[r'litriErogati.lessThan'] = litriErogatiPeriodLessThan;
    queryParams[r'litriErogati.lessThanOrEqual'] =
        litriErogatiPeriodLessThanOrEqual;
    ...
    queryParams[r'prezzoAlLitro.greaterThanOrEqual'] =
        prezzoAlLitroPeriodGreaterThanOrEqual;
    queryParams[r'prezzoAlLitro.in'] = prezzoAlLitroPeriodIn;
    queryParams[r'prezzoAlLitro.lessThan'] = prezzoAlLitroPeriodLessThan;
    queryParams[r'prezzoAlLitro.lessThanOrEqual'] =
        prezzoAlLitroPeriodLessThanOrEqual;
  ...
  Future<Response<Rifornimento>> createRifornimentoUsingPOST({
    ...
    return _dio
      ...
      onReceiveProgress: onReceiveProgress,
        ...
        .then((response) {
      final serializer = _serializers.serializerForType(Rifornimento)
          as Serializer<Rifornimento>;
      final data = _serializers.deserializeWith<Rifornimento>(serializer,
  ...
  Future<Response<void>> deleteRifornimentoUsingDELETE(
    ...
    final String _path =
        '/api/rifornimentos/{id}'.replaceAll('{' r'id' '}', id.toString());
  ...
  Future<Response<BuiltList<Rifornimento>>> getAllRifornimentosUsingGET({
    ...
    return _dio
      ...
      final BuiltList<Rifornimento> data = _serializers.deserialize(
          response.data is String ? jsonDecode(response.data) : response.data,
          specifiedType: type) as BuiltList<Rifornimento>;
