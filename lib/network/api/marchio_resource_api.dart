...
class MarchioResourceApi {
  ...
  Future<Response<Marchio>> createMarchioUsingPOST({
    ...
    return _dio
      ...
      onReceiveProgress: onReceiveProgress,
        ...
        .then((response) {
      final serializer =
          _serializers.serializerForType(Marchio) as Serializer<Marchio>;
      final data = _serializers.deserializeWith<Marchio>(serializer,
  ...
  Future<Response<void>> deleteMarchioUsingDELETE(
    ...
    final String _path =
        '/api/marchios/{id}'.replaceAll('{' r'id' '}', id.toString());
  ...
  Future<Response<BuiltList<Marchio>>> getAllMarchiosUsingGET({
    ...
    return _dio
      ...
      final BuiltList<Marchio> data = _serializers.deserialize(
          response.data is String ? jsonDecode(response.data) : response.data,
          specifiedType: type) as BuiltList<Marchio>;
