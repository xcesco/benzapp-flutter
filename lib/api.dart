...
import 'package:api/api/account_resource_api.dart';
import 'package:api/api/cittadino_resource_api.dart';
import 'package:api/api/delega_resource_api.dart';
import 'package:api/api/device_resource_api.dart';
import 'package:api/api/fascia_resource_api.dart';
import 'package:api/api/gestore_resource_api.dart';
import 'package:api/api/marchio_resource_api.dart';
import 'package:api/api/notifica_resource_api.dart';
import 'package:api/api/public_user_resource_api.dart';
import 'package:api/api/rifornimento_resource_api.dart';
import 'package:api/api/tessera_resource_api.dart';
import 'package:api/api/user_jwt_controller_api.dart';
import 'package:api/api/user_resource_api.dart';
import 'package:api/auth/api_key_auth.dart';
import 'package:api/auth/basic_auth.dart';
import 'package:api/auth/oauth.dart';
import 'package:api/serializers.dart';
