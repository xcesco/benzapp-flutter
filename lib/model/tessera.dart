...
class TesseraCarburanteEnum extends EnumClass {
  ...
  static Serializer<TesseraCarburanteEnum> get serializer => _$tesseraCarburanteEnumSerializer;

  const TesseraCarburanteEnum._(String name): super(name);

  static BuiltSet<TesseraCarburanteEnum> get values => _$tesseraCarburanteEnumValues;
  static TesseraCarburanteEnum valueOf(String name) => _$tesseraCarburanteEnumValueOf(name);
}

class TesseraVeicoloEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'AUTOVEICOLO')
  static const TesseraVeicoloEnum AUTOVEICOLO = _$tesseraVeicoloEnum_AUTOVEICOLO;
  @BuiltValueEnumConst(wireName: r'CICLOMOTORE')
  static const TesseraVeicoloEnum CICLOMOTORE = _$tesseraVeicoloEnum_CICLOMOTORE;
  @BuiltValueEnumConst(wireName: r'MOTOVEICOLO')
  static const TesseraVeicoloEnum MOTOVEICOLO = _$tesseraVeicoloEnum_MOTOVEICOLO;

  static Serializer<TesseraVeicoloEnum> get serializer => _$tesseraVeicoloEnumSerializer;
  ...
  static TesseraVeicoloEnum valueOf(String name) => _$tesseraVeicoloEnumValueOf(name);
}
