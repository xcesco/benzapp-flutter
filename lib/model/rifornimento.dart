...
abstract class Rifornimento implements Built<Rifornimento, RifornimentoBuilder> {
...
class RifornimentoTipoCarburanteEnum extends EnumClass {
  ...
  static const RifornimentoTipoCarburanteEnum BENZINA = _$rifornimentoTipoCarburanteEnum_BENZINA;
  @BuiltValueEnumConst(wireName: r'DIESEL')
  static const RifornimentoTipoCarburanteEnum DIESEL = _$rifornimentoTipoCarburanteEnum_DIESEL;

  static Serializer<RifornimentoTipoCarburanteEnum> get serializer => _$rifornimentoTipoCarburanteEnumSerializer;

  const RifornimentoTipoCarburanteEnum._(String name): super(name);

  static BuiltSet<RifornimentoTipoCarburanteEnum> get values => _$rifornimentoTipoCarburanteEnumValues;
  static RifornimentoTipoCarburanteEnum valueOf(String name) => _$rifornimentoTipoCarburanteEnumValueOf(name);
}
