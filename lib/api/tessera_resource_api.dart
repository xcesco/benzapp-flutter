...
class TesseraResourceApi {
  ...
  Future<Response<Tessera>> createTesseraUsingPOST({
    ...
    return _dio
      ...
      onReceiveProgress: onReceiveProgress,
        ...
        .then((response) {
      final serializer =
          _serializers.serializerForType(Tessera) as Serializer<Tessera>;
      final data = _serializers.deserializeWith<Tessera>(serializer,
  ...
  Future<Response<void>> deleteTesseraUsingDELETE(
    ...
    final String _path =
        '/api/tesseras/{id}'.replaceAll('{' r'id' '}', id.toString());
