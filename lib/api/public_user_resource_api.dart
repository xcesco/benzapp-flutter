...
class PublicUserResourceApi {
    ...
    Future<Response<BuiltList<UserDTO>>> getAllPublicUsersUsingGET({ 
        ...
        return _dio.request(
            ...
            final BuiltList<UserDTO> data = _serializers.deserialize(response.data is String ? jsonDecode(response.data) : response.data, specifiedType: type) as BuiltList<UserDTO>;
    ...
    Future<Response<BuiltList<String>>> getAuthoritiesUsingGET({ 
        ...
        return _dio.request(
            ...
            final BuiltList<String> data = _serializers.deserialize(response.data is String ? jsonDecode(response.data) : response.data, specifiedType: type) as BuiltList<String>;
