...
class CittadinoResourceApi {
    ...
    Future<Response<int>> countCittadinosUsingGET({ 
        ...
        queryParams[r'codiceFiscale.doesNotContain'] = codiceFiscalePeriodDoesNotContain;
        ...
        queryParams[r'fasciaId.greaterThanOrEqual'] = fasciaIdPeriodGreaterThanOrEqual;
    ...
    Future<Response<Cittadino>> createCittadinoUsingPOST({ 
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(Cittadino) as Serializer<Cittadino>;
            final data = _serializers.deserializeWith<Cittadino>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
    ...
    Future<Response<void>> deleteCittadinoUsingDELETE(
        ...
        final String _path = '/api/cittadinos/{id}'.replaceAll('{' r'id' '}', id.toString());
    ...
    Future<Response<BuiltList<Cittadino>>> getAllCittadinosUsingGET({ 
        ...
        return _dio.request(
            ...
            final BuiltList<Cittadino> data = _serializers.deserialize(response.data is String ? jsonDecode(response.data) : response.data, specifiedType: type) as BuiltList<Cittadino>;
