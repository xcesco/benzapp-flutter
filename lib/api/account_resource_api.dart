...
class AccountResourceApi {
    ...
    Future<Response<AdminUserDTO>> getAccountUsingGET({ 
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(AdminUserDTO) as Serializer<AdminUserDTO>;
            final data = _serializers.deserializeWith<AdminUserDTO>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
