...
class GestoreResourceApi {
    ...
    Future<Response<int>> countGestoresUsingGET({ 
        ...
        queryParams[r'benzinaPrezzoAlLitro.equals'] = benzinaPrezzoAlLitroPeriodEquals;
        queryParams[r'benzinaPrezzoAlLitro.greaterThan'] = benzinaPrezzoAlLitroPeriodGreaterThan;
        queryParams[r'benzinaPrezzoAlLitro.greaterThanOrEqual'] = benzinaPrezzoAlLitroPeriodGreaterThanOrEqual;
        queryParams[r'benzinaPrezzoAlLitro.in'] = benzinaPrezzoAlLitroPeriodIn;
        queryParams[r'benzinaPrezzoAlLitro.lessThan'] = benzinaPrezzoAlLitroPeriodLessThan;
        queryParams[r'benzinaPrezzoAlLitro.lessThanOrEqual'] = benzinaPrezzoAlLitroPeriodLessThanOrEqual;
        queryParams[r'benzinaPrezzoAlLitro.notEquals'] = benzinaPrezzoAlLitroPeriodNotEquals;
        queryParams[r'benzinaPrezzoAlLitro.notIn'] = benzinaPrezzoAlLitroPeriodNotIn;
        queryParams[r'benzinaPrezzoAlLitro.specified'] = benzinaPrezzoAlLitroPeriodSpecified;
        ...
        queryParams[r'gasolioPrezzoAlLitro.equals'] = gasolioPrezzoAlLitroPeriodEquals;
        queryParams[r'gasolioPrezzoAlLitro.greaterThan'] = gasolioPrezzoAlLitroPeriodGreaterThan;
        queryParams[r'gasolioPrezzoAlLitro.greaterThanOrEqual'] = gasolioPrezzoAlLitroPeriodGreaterThanOrEqual;
        queryParams[r'gasolioPrezzoAlLitro.in'] = gasolioPrezzoAlLitroPeriodIn;
        queryParams[r'gasolioPrezzoAlLitro.lessThan'] = gasolioPrezzoAlLitroPeriodLessThan;
        queryParams[r'gasolioPrezzoAlLitro.lessThanOrEqual'] = gasolioPrezzoAlLitroPeriodLessThanOrEqual;
        queryParams[r'gasolioPrezzoAlLitro.notEquals'] = gasolioPrezzoAlLitroPeriodNotEquals;
        queryParams[r'gasolioPrezzoAlLitro.notIn'] = gasolioPrezzoAlLitroPeriodNotIn;
        queryParams[r'gasolioPrezzoAlLitro.specified'] = gasolioPrezzoAlLitroPeriodSpecified;
        ...
        queryParams[r'latitudine.greaterThanOrEqual'] = latitudinePeriodGreaterThanOrEqual;
        queryParams[r'latitudine.in'] = latitudinePeriodIn;
        queryParams[r'latitudine.lessThan'] = latitudinePeriodLessThan;
        queryParams[r'latitudine.lessThanOrEqual'] = latitudinePeriodLessThanOrEqual;
        ...
        queryParams[r'longitudine.greaterThanOrEqual'] = longitudinePeriodGreaterThanOrEqual;
        queryParams[r'longitudine.in'] = longitudinePeriodIn;
        queryParams[r'longitudine.lessThan'] = longitudinePeriodLessThan;
        queryParams[r'longitudine.lessThanOrEqual'] = longitudinePeriodLessThanOrEqual;
        ...
        queryParams[r'marchioId.greaterThanOrEqual'] = marchioIdPeriodGreaterThanOrEqual;
    ...
    Future<Response<Gestore>> createGestoreUsingPOST({ 
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(Gestore) as Serializer<Gestore>;
            final data = _serializers.deserializeWith<Gestore>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
    ...
    Future<Response<void>> deleteGestoreUsingDELETE(
        ...
        final String _path = '/api/gestores/{id}'.replaceAll('{' r'id' '}', id.toString());
    ...
    Future<Response<BuiltList<Gestore>>> getAllGestoresUsingGET({ 
        ...
        return _dio.request(
            ...
            final BuiltList<Gestore> data = _serializers.deserialize(response.data is String ? jsonDecode(response.data) : response.data, specifiedType: type) as BuiltList<Gestore>;
